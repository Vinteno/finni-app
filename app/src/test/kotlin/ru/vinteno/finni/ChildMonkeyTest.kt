 ...
 * по настоящему приложению целиком. После каждого шага проверяются инварианты продукта. Находки не валят тест, а собираются в отчёт build/qa/monkey-report.md:
